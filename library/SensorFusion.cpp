...
void SF::MahonyUpdate_imu(float gx, float gy, float gz, float ax, float ay, float az, float deltat)
{
	float recipNorm;
...
void SF::MadgwickUpdate_imu(float gx, float gy, float gz, float ax, float ay, float az, float deltat) {
	float recipNorm;
	float s0, s1, s2, s3;
	float qDot1, qDot2, qDot3, qDot4;
