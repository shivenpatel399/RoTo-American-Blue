...
int routeSteps[] = {12,11,21,31,32,22,12,13,23,24,14,24,34,44,54,44,43,42,43,33,43,42,52,51}; // (19.5 + Error / 13)
// Test Run #1 {12,11,21,31,32,22,12,13,23,24,34,44,54,44,43,42,43,33,43,42,52,51} // (19.5 + Error / 13)
// Test Run #2 {12,11,21,31,32,22,12,13,23,24,34,44,43,42,43,33,43,42,52,51} // (19.5 + Error / 13)
...
void speedTime_control(float Time) { // Critical Change Point
  ...
  powerneeded = 12.3 + (3.21 * distovertime) + (-0.0149 * pow(distovertime, 2));
